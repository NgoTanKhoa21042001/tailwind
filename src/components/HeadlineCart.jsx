...
const HeadlineCart = () => {
  return (
    <div className="max-w-[1654px] mx-auto p-4 py-12 grid grid-cols-3 gap-6">
      {/* Card */}
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          ...
          <button className="border-white bg-white absolute text-black bottom-4 mx-2">
            Order Now
          </button>
        </div>
        <img
      ...
      <div className="rounded-xl relative">
        ...
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
          src="https://images.unsplash.com/photo-1565958011703-44f9829ba187?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8Rm9vZHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
          alt="/"
        />
      </div>
    </div>
